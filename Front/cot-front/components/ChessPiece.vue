<template>
    <font-awesome-icon :icon="chessboard_to_icon_text(icon)" />
</template>
...
library.add(blackPawn,whitePawn,blackRook,whiteRook,blackBishop,whiteBishop,blackKnight,whiteKnight,blackQueen,whiteQueen,blackKing,whiteKing);
